...
These steps should be easy to click-through if you are using the bookbag terminal.  Executing these tasks is a requirement before proceeding with the workshop exercises.
